...
public class Button {
    ...
    public Button[] neighbors;   //Just Save Current neighbors
    public int live;
    public boolean isDeleted;
    public boolean isDead;      //Used for Count Points Alive
    public boolean isLastButton;
    public boolean isCauseButton;
    public Button becauseOf;   //This goButton is deleted becaue of the becauseOf goButton.
    
    private static boolean[][] isChecked = new boolean[19][19];

    public Button(int centerX, int centerY, Color buttonColor) {
    ...
    public void selfDelete(Vector buttonVect, Button[][] playButtons, Button causeButton) {
