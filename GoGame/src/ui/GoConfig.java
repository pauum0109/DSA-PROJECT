...
Purpose: Manage user selections and updates to the game configuration
*/
package ui;
...
public class GoConfig extends JPanel implements ActionListener {
    ...
    public GoConfig(GoBoard goBoard, Client goNetClient) {
        ...
        submitButton.setFont(FontManager.buttonFont);
    ...
    private void configSubmit() {
        ...
        Object sentObject = new Object(Constants.CONFIG, playIndex, handiNum, isSelected);
