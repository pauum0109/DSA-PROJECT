...
Purpose: Manage and apply color preferences in a graphical user interface.
*/
package ui;
...
public class ColorSelection extends JDialog implements ActionListener {
    ...
    public ColorSelection(Frame fOwner, String str, boolean modal, Color[] oldColors) {
