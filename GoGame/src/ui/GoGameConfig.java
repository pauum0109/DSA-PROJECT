...
Purpose: File handling to manage a list of useful words in a Go board game configuration dialog
*/
package ui;
...
public class GoGameConfig extends JDialog implements ActionListener, ListSelectionListener {
    private JList<String> goList;
    private DefaultListModel<String> goListModel;

    private PopupTextField wordsText;
    ...
    public GoGameConfig(Frame fOwner, String str, boolean modal) {
        ...
        wordsText = new PopupTextField(words, 10);
        wordsText.addActionListener(this);
     
        addButton = new JButton(addString);
        addButton.setFont(FontManager.buttonFont);
        addButton.addActionListener(this);

        removeButton = new JButton(removeString);
        removeButton.setFont(FontManager.buttonFont);
        ...
        resetButton.setFont(FontManager.buttonFont);
    ...
    public void actionPerformed(ActionEvent e) {
        if ((e.getSource() == wordsText) || (e.getSource() == addButton)) {
            ...
            try {
                ...
                UsefulWords wordsObject = new UsefulWords(wordsVect);
