...
Purpose: Provides a structured approach to managing notifications in a Java Swing application
*/
package ui;
...
public class GoInform extends JDialog implements ActionListener {
    ...
    private PopupTextField audioText;
    private JButton          audioBrowseButton;
    private PopupTextField emailAddressText;
    private JLabel           domainLabel;
    private PopupTextField domainText;
    private JRadioButton     emailDefaultButton, emailDefineButton;
    private JLabel           emailTopicLabel;
    private PopupTextField emailTopicText;
    private JLabel           emailContentLabel;
    private PopupTextArea  emailContentText;
    ...
    public GoInform(Frame fOwner, String str, boolean modal) {
        ...
        goFileChooser.addChoosableFileFilter(new AudioFilter());
        ...
        upPanel.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), 
                                                           " Use the Following Way to Notify Me ", TitledBorder.LEADING,
                                                           TitledBorder.TOP, FontManager.labelFont),
